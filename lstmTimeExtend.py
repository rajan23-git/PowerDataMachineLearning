...
pastSize = 96 #uses the past 60 weather values
futureSize = 48 #to predict the next 4 power outsputs
#normalize 
...
model.add(layers.LSTM(200, return_sequences=True, input_shape=(x_train.shape[1], 4)))
